...
<script>
export default {
  name: 'CollegeAdminTabBar',
  props: { current: { type: String, default: 'pages/college-admin/dashboard' } },
  data() {
    return {
      safeBottom: 0,
      tabs: [
        { page: 'pages/college-admin/dashboard', label: '首页', icon: '🏠' },
        { page: 'pages/college-admin/profile', label: '我的', icon: '👤' }
      ]
    }
  },
  created() {
