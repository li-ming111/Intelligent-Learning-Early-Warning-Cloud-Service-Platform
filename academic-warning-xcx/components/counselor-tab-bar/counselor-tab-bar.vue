...
<script>
export default {
  name: 'CounselorTabBar',
  props: { current: { type: String, default: 'pages/counselor/dashboard' } },
  data() {
    return {
      safeBottom: 0,
      tabs: [
        { page: 'pages/counselor/dashboard', label: '首页', icon: '🏠' },
        { page: 'pages/counselor/warnings', label: '预警', icon: '⚠' },
        { page: 'pages/counselor/assistance', label: '帮扶', icon: '🎯' },
        { page: 'pages/counselor/students', label: '学生', icon: '👨‍🎓' },
        { page: 'pages/counselor/profile', label: '我的', icon: '👤' }
      ]
    }
  },
  created() {
