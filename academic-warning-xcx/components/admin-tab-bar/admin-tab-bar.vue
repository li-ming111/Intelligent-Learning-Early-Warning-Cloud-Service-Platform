...
export default {
  name: 'AdminTabBar',
  props: { current: { type: String, default: 'pages/admin/dashboard' } },
  data() {
    return {
      safeBottom: 0,
      tabs: [
        { page: 'pages/admin/dashboard', label: '首页', icon: '🏠' },
        { page: 'pages/admin/users', label: '用户', icon: '👤' },
        { page: 'pages/admin/profile', label: '我的', icon: '⚙' }
      ]
    }
  },
  created() {
